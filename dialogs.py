    ...
    def __init__(self, title, sections, done_button_title='Done'):
        ...
        for section in self.sections:
            ...
            for i, item in enumerate(items):
                ...
                background_color = item.get('background_color', None)
                if background_color:
...
def time_dialog(title='', done_button_title='Done'):
    c = _DateDialogController(mode=ui.DATE_PICKER_MODE_TIME, title=title, done_button_title=done_button_title)
    c.container_view.present('sheet')
    c.container_view.wait_modal()
    if c.was_canceled:
        return None
...
def datetime_dialog(title='', done_button_title='Done'):
    c = _DateDialogController(mode=ui.DATE_PICKER_MODE_DATE_AND_TIME, title=title, done_button_title=done_button_title)
    c.container_view.present('sheet')
    c.container_view.wait_modal()
    if c.was_canceled:
        return None
...
def duration_dialog(title='', done_button_title='Done'):
    c = _DateDialogController(mode=ui.DATE_PICKER_MODE_COUNTDOWN, title=title, done_button_title=done_button_title)
    c.container_view.present('sheet')
    c.container_view.wait_modal()
    if c.was_canceled:
        return None
